...
<?php
	...
	if($row1['twp']>=$row2['twp_e'])
		echo "12th %age required greater than ".$row2['twp_e']." <img src=\"Images/tick.png\" height=\"20\" width=\"20\" ><BR>";
	else
		echo "12th %age required greater than ".$row2['twp_e']." <img src=\"Images/cross.png\" height=\"20\" width=\"20\" ><BR>";
	
	if($row1['tenp']>=$row2['tenp_e'])
		echo "10th %age required greater than ".$row2['tenp_e']." <img src=\"Images/tick.png\" height=\"20\" width=\"20\" ><BR>";
	else
		echo "10th %age required greater than ".$row2['tenp_e']." <img src=\"Images/cross.png\" height=\"20\" width=\"20\" ><BR>";
