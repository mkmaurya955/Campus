	...
	<head>
	  ...
	  <?php
		...
		if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$sql="INSERT into vacancy(company_name,job_title,salary,location,deadline,bond,age,degree,cpi,year,twp,tenp) values(\"".$_SESSION['name']."\",\"".$job_title."\",".$salary.",\"".$location."\",\"".$deadline."\",".$bond.",".$age.",\"".$degree."\",".$cpi.",".$year.",".$twp.",".$tenp." );";
			;
